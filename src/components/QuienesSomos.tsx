      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "left" }}>
            ...
            >
              Combina desarrollo web con investigación de producto para crear MVPs y pruebas de concepto orientas a validar ideas en el mercado. Trabaja con metodologías Lean y Product Discovery para reducir el riesgo de construir productos sin demanda real.
            </p>
          </div>
        </div>
        {/* Cepeda Damaris */}
